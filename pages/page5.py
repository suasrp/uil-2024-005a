...
st.write(
    """
# 📝 7th-8th Grade - List of Words

---Words starting with 'A':

abandon, absent, absolute, academy, ache, address, adult, afterglow, against, airliner, alley, allspice, almond, already, alter, ambition, amusement, ancestor, annual, apology, appetite, argue, artist, assign, astronomer, athlete, autograph, autumn, awesome
